...
import { awaitDeviceLastUsed, awaitPushDelivery, enablePushFromSettings, pushCatcherEndpoint, resetPushCatcher, resetPushSubscriptions, setPageVisibility, stubPushManager, } from "../fixtures/push";
...
test("device row shows the activity instant + marks the device you are on", async ({ page, context, browser, }) => {
    const vjt = specUser();
