...
test("@webkit iOS — a short tap on a scrollback link keeps the keyboard (mousedown focus-shift prevented, compose stays focused)", async ({ page, }) => {
    const vjt = specUser();
