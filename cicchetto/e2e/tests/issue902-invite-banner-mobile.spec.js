...
// behaviour.
import { composeSend, inviteBanner, inviteBannerJoin, loginAs, selectChannel, sidebarWindow, } from "../fixtures/cicchettoPage";
...
test("@webkit @touch #902 — an inbound INVITE reaches a phone via the banner, not the BottomBar", async ({ page, }) => {
    const vjt = specUser();
