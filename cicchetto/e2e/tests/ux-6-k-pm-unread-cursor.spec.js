...
// that was broken.
import { loginAs, scrollbackLine, selectChannel, sidebarWindow, waitForDmListenerReady, } from "../fixtures/cicchettoPage";
...
test("UX-6 K — focus-leave on a peer DM window advances the server-side read cursor for the peer", async ({ page, }) => {
    const vjt = specUser();
