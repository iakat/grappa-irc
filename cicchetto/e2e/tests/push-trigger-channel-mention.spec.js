...
import { assertNoPushDeliveryOnUnusedId, awaitPushDelivery, enablePushFromSettings, expectRfc8291Delivery, pushCatcherEndpoint, resetPushCatcher, resetPushSubscriptions, setPageVisibility, stubPushManager, } from "../fixtures/push";
import { AUTOJOIN_CHANNELS, NETWORK_SLUG } from "../fixtures/seedData";
import { expect, specNick, specUser, test } from "../fixtures/test";
const PEER_NICK = "b5-mentioner";
const TARGET_CHANNEL = "#b5-mention";
const SUB_ID = "channel-mention";
test("channel mention while push-enabled fires Sender → push-catcher receives a POST", async ({ page, context, }) => {
    const vjt = specUser();
