...
import { composeSend, loginAs, scrollbackDistanceFromBottom, scrollbackLines, selectChannel, } from "../fixtures/cicchettoPage";
...
test.describe("scroll-to-bottom button (iOS) — tap then window roundtrip lands at bottom", () => {
    test("@webkit @touch tap scroll-to-bottom, bounce to empty query and back, lands at bottom", async ({ page, }) => {
        const vjt = specUser();
