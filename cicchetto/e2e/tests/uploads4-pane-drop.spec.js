...
async function fireFileDrag(scrollback, type) {
...
test("uploads-4 #351 — a file dropped over the SCROLLBACK uploads (whole pane is the drop target)", async ({ page, browserName, }) => {
    test.skip(browserName !== "chromium", "drag-and-drop of an OS file is a desktop-pointer feature; WebKit programmatic DragEvent/DataTransfer is unreliable");
    if (!CHANNEL)
