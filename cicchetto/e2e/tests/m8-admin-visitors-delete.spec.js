...
test("M-8 admin deletes a minted visitor from the unified Sessions view (inline confirm two-step)", async ({ page, }) => {
    ...
    try {
        ...
        const survivingVerbs = page.locator(`[data-testid^="admin-session-disconnect-visitor:${visitor.id}:"],` +
