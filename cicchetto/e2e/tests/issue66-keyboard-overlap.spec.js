...
test("@webkit @touch issue66 — composer + last message stay inside the keyboard-shrunk viewport", async ({ page, }) => {
    const vjt = specUser();
    ...
    await page.evaluate((px) => {
        ...
        if (!vv)
            throw new Error("issue66 spec: window.visualViewport unavailable");
