...
async function openEditorFromGallery(page) {
...
test.describe("#294 — built-in background picker", () => {
    test("picker renders the catalog + selecting a built-in applies the wallpaper live", async ({ page, }) => {
        ...
        // The picker renders the server-owned catalog (14 cover backgrounds: the 8
        // v1 covers + 6 generated by scripts/gen-backgrounds.py, #334). The count
        // is server-owned truth — BuiltinBackgrounds.@catalog, pinned by
        // builtin_backgrounds_test.exs "all/0 is the curated set of 14".
