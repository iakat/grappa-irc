...
import { composeSend, confirmModal, confirmModalYes, loginAs, selectChannel, sidebarCloseButton, sidebarWindow, } from "../fixtures/cicchettoPage";
...
test("issue #38 — × dismisses a 475-failed +k autojoin channel row", async ({ page }) => {
    ...
    await expect(sidebarWindow(page, NETWORK_SLUG, SEED_CHANNEL).locator(".sidebar-window-greyed")).toHaveCount(0, { timeout: 20_000 });
