...
import { closeArchive, composeSend, loginAs, openArchive, openRailMenu, selectChannel, } from "../fixtures/cicchettoPage";
...
test("@webkit @touch #881 — a non-joined channel window keeps every rail door, and still no members list", async ({ page, }) => {
    const vjt = specUser();
