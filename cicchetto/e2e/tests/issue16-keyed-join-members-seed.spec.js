...
test("issue #16 — members pane seeds on a keyed JOIN and survives a cold WS resubscribe (no stuck loading…)", async ({ page, }) => {
...
async function assertMembersSeeded(page, peerNick) {
