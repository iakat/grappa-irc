...
import { closeArchive, composeSend, expandArchiveGroup, loginAs, openArchive, selectChannel, sidebarWindow, } from "../fixtures/cicchettoPage";
...
test("@webkit @touch #402 — a failed-JOIN window with scrollback stays reachable from exactly one mobile surface", async ({ page, }) => {
    const vjt = specUser();
