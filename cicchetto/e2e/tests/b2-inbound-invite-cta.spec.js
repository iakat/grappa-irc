...
import { inviteBanner, inviteBannerJoin, loginAs, selectChannel, sidebarWindow, } from "../fixtures/cicchettoPage";
...
test("B2 — inbound INVITE raises a banner naming the inviter; its [Join] mounts + focuses the channel", async ({ page, }) => {
    const vjt = specUser();
