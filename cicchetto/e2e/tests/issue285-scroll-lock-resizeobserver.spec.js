...
async function setViewportVarsNoResize(page, px) {
...
test("@webkit @touch #285 reopen — .scrollback base is fail-open pan-y and the lock gate re-measures on a container height change with NO resize event", async ({ page, }) => {
