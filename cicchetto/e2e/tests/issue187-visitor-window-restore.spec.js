...
import { bootVisitorContext, composeSend, expectShellReady, selectChannel, sidebarWindow, waitForUserTopicReady, } from "../fixtures/cicchettoPage";
import { mintVisitor, reapVisitors } from "../fixtures/grappaApi";
import { getSeededAdmin } from "../fixtures/seedData";
import { expect, test } from "../fixtures/test";
test("issue #187 — a visitor's last-open channel is restored on refresh/reopen (not $home)", async ({ browser, }) => {
