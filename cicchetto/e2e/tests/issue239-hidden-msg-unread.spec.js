...
import { loginAs, openRailMenu, selectChannel, sidebarEventsBadge, sidebarMessageBadge, } from "../fixtures/cicchettoPage";
...
test("#239 — hidden control message does NOT bump the unread badge; reading clears it", async ({ page, }) => {
    const vjt = specUser();
    ...
    try {
        ...
        await expect(page
            ...
            .filter({ hasText: WITNESS })).toBeVisible({ timeout: 10_000 });
