...
import { composeSend, loginAs, scrollbackLines, selectChannel, sidebarWindow, } from "../fixtures/cicchettoPage";
...
async function scrollScrollbackTo(page, scrollTop) {
...
test.describe("scroll-multi-roundtrip — N back-and-forths preserve destination scroll", () => {
    ...
    test("channel→empty-query→channel-back repeated 5× lands at bottom every return", async ({ page, }) => {
        const vjt = specUser();
