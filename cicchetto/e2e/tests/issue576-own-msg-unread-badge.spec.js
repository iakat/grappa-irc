...
import { assertMessagePersisted, fetchAllMessagesAsc, restoreReadCursorToTail, setReadCursorToId, } from "../fixtures/grappaApi";
...
test("#576 — own content lines don't badge; a later peer line does", async ({ page }) => {
    ...
    try {
        ...
        await setReadCursorToId(vjt.token, NETWORK_SLUG, peer.nick, openerId);
