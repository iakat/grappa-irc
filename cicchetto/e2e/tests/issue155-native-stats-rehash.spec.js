...
import { bootVisitorContext, composeSend, expectShellReady, scrollbackLine, selectChannel, } from "../fixtures/cicchettoPage";
...
test("issue #155 — native /stats and /rehash ship upstream and render reply numerics in $server", async ({ browser, }) => {
