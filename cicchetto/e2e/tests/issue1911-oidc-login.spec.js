...
async function readInstalledSubject(page) {
...
test.describe("#1911 OIDC login through the stub provider", () => {
    test("a linked provider identity logs in over verified TLS and lands on the user home", async ({ page, }) => {
