...
async function readDeclaredHeight(page, selector, prop) {
    return await page.evaluate(({ selector, prop }) => {
...
test("@webkit @touch ux-5-bv — .shell-members reads var(--viewport-height) with 100dvh fallback", async ({ page, }) => {
    const vjt = specUser();
...
test("@webkit @touch ux-5-bv — .settings-drawer reads var(--viewport-height) with 100dvh fallback", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bv — .archive-modal caps max-height to var(--viewport-height)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bv — .image-upload-modal caps max-height to var(--viewport-height)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bv — .home-pane caps max-height to var(--viewport-height)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bv — .admin-pane caps max-height to var(--viewport-height)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bv — .admin-tab-panel caps max-height to var(--viewport-height)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bv — mobile members drawer auto-closes when operator taps a member nick", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
