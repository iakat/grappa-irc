...
async function readDeclaredCssValue(page, selector, prop) {
...
test("@webkit @touch ux-5-bd — .settings-drawer padding uses 1.5rem env() bottom floor", async ({ page, }) => {
    const vjt = specUser();
...
test("@webkit @touch ux-5-bd — .settings-drawer computed padding-bottom >= 1.5rem floor (non-notched)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bd — .archive-modal padding uses 1.5rem env() bottom floor", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bd — .archive-modal computed padding-bottom >= 1.5rem floor (non-notched)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bd — .image-upload-modal padding uses 1.5rem env() bottom floor", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bd — .shell-members padding-bottom uses 1.5rem env() floor (BM launcher footer trap)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
...
test("@webkit @touch ux-5-bd — .shell-members computed padding-bottom >= 1.5rem floor (non-notched)", async ({ page, }) => {
    const vjt = specUser();
    await loginAs(page, vjt);
