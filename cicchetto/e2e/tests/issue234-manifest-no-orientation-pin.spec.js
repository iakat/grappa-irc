...
test("#234 served PWA manifest does not pin orientation (honors OS rotation lock)", async ({ request, }) => {
    ...
    expect(manifest, "manifest must NOT pin orientation (honors the OS rotation lock, #234)").not.toHaveProperty("orientation");
});
