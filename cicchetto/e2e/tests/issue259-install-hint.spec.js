...
test.describe("issue259 install-hint — per-platform branch rendering", () => {
    ...
    test("@webkit issue259 — iOS Safari branch points at the ⋯ menu with emphasized glyph + arrow", async ({ page, }) => {
    ...
    test("issue259 — Chromium branch shows the native Install button and NO arrow", async ({ page, }) => {
    ...
    test("issue259 — non-iOS with no prompt gracefully hides the CTA (menu hint, no dead button)", async ({ page, }) => {
