...
import { loginAs, openSettingsSection, selectChannel, sidebarMessageBadge, sidebarWindow, } from "../fixtures/cicchettoPage";
...
test("Alt+A skips the muted channel and lands on the unmuted one, badge intact", async ({ page, }) => {
    const vjt = specUser();
