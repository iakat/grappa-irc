...
test("ux-5-bs desktop — drag left handle widens sidebar + persists across reload", async ({ page, }) => {
    const vjt = specUser();
...
test("ux-5-bs mobile — drag handles NOT present (mobile branch never mounts them)", async ({ browser, }) => {
