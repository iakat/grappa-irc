 ...
 */
export function buildPushDeepLink(networkSlug, target) {
 ...
 */
export async function dispatchNavigateMessage(page, url) {
    await page.evaluate((targetUrl) => {
        navigator.serviceWorker.dispatchEvent(new MessageEvent("message", { data: { type: "navigate", url: targetUrl } }));
    }, url);
}
